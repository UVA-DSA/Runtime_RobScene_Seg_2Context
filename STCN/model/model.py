...
class STCNModel:
    def __init__(self, para, logger=None, save_path=None, local_rank=0, world_size=1):
        ...
        self.train_integrator = Integrator(self.logger, distributed=False, local_rank=local_rank, world_size=world_size) # set distributed to false, local_rank, world_size no use
        ...
        # Logging info
        self.report_interval = 50 #300#100
        self.save_im_interval = 50 #300#800
        self.save_model_interval = 50 #300 if para['stage']==0 else 18000
        if para['debug']:
    ...
    def load_model(self, path):
        ...
        map_location = 'cuda:%d' % self.local_rank
        self.STCN.load_state_dict(network) # removed module
    ...
    def load_network(self, path):
        ...
        self.STCN.load_state_dict(src_dict) # removed module
