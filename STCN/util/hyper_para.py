...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        # Data parameters
        parser.add_argument('--jigsaws', help='training data root', 
                            default='/Documents/segmentation/JIGSAWS-Cogito-Annotations-main')

        parser.add_argument('--num_workers', help='Number of datalaoder workers per process', type=int, default=10)
        ...
        parser.add_argument('--stage', help='Training stage (0-static images,2-JIGSAWS', type=int, default=1)
        ...
        if self.args['stage'] == 0:
            ...
            self.args['iterations'] = none_or_default(self.args['iterations'], 30)
            ...
            self.args['lr'] = none_or_default(self.args['lr'], 1e-5)
            self.args['batch_size'] = none_or_default(self.args['batch_size'], 4)
            self.args['iterations'] = none_or_default(self.args['iterations'], 300*6)
